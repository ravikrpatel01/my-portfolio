...
const Navbar = () => {
  return (
    <div className="bg-[#212121] fixed px-8 z-50 py-6 top-0 flex items-center w-full h-[90px] border-b-[1px] border-emerald-800">
      <div className=" flex items-center w-full justify-between">
        ...
        <div className="">
          <ul className="flex gap-6 text-[1.2rem] text-white font-semibold">
            <Link to="home" smooth={true} duration={500}>
        ...
        <div className="flex items-center">
          ...
          <div className="">
            <a href="https://drive.google.com/uc?export=download&id=12qGPmltHvBb6RTdpq-LOCoPFYt6FGshT" download target="_blank" rel="noopener noreferrer">
